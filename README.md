...
![modules](https://img.shields.io/badge/modules-466-brightgreen) ![vendors](https://img.shields.io/badge/vendors-67-blue) ![ladder](https://img.shields.io/badge/SDR%20ladder-tier%200--5-orange) ![license](https://img.shields.io/badge/license-CC0--1.0-lightgrey)
...
**Catalog at a glance** — **433 modules across 54 vendors**, each scored on the SDR ladder: **265** reach monitor + injection (Tier 1), **43** expose CSI (Tier 2), **53** do spectral / raw‑PHY scan (Tier 3), **15** have raw‑IQ / arbitrary‑waveform TX (Tier 4 — incl. FMCW radar silicon), and **21** are open‑firmware or true‑SDR references (Tier 5); a further **69** are catalogued as stock‑only (Tier 0 — the chip exists, but no public path off the ground floor yet). Full machine‑readable database: [data/modules.json](data/modules.json) · [modules.csv](data/modules.csv). *(These numbers grow every research cycle.)*
